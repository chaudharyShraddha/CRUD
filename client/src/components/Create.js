...
const ADD_BOOK = gql`
    mutation AddBook($title: String,$author: String,$description: String,$publisher: String,$published_year: String) {
        addBook(
            title: $title,
            author: $author,
                ...
                <div className="container">
                    <div className="panel panel-default">
                        ...
                        <div className="panel-body">
                            <h4><Link to="/" className="btn btn-primary mb-4">Book List</Link></h4>
                            <form onSubmit={e => {
                                e.preventDefault();
                                addBook({ variables: { title: title.value, author: author.value, description: description.value, publisher: publisher.value, published_year: published_year.value } });
                                title.value = "";
                                author.value = "";
                                description.value = "";
